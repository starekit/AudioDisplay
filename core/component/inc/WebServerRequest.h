...
class WebServerRequest{
        ...
        public:
            void send(int statusCode=200,const char* contentType = "text/html", const std::string* content=nullptr);   
            ...
            void sendError(int statusCode, const std::string* message = nullptr);
